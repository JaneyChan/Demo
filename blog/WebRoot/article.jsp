...
<body>
		...
		<div class=" jsc-sidebar-content jsc-sidebar-pulled">
			<div class="m-header">
				<a class="m-menu jsc-sidebar-trigger"></a> <a href="#">欲思博客</a> <a
					href="http://guimeng.sinaapp.com/wp-login.php" class="m-admin"></a>
			</div>
			<div class="blogitem">
				...
				<div class="content">
					<article
						...
						<h2 class="title" style="text-align:center;">
							<div><a class="slow" title="${article.title }">${article.title }</a></div>
							<div class="edit">发布时间：${article.publishTime } &nbsp;&nbsp;文章分类：${category.cateName }</div>
						</h2>
						<ul class="text">
							${article.content }
						</ul>
				...
				<div id="comments">
					<div id="respond">
						<form action="Comment_add"
							method="post" id="commentform">
							<div class="f-publish" id="real-avatar">
								<span> <img src="images/default.png" class="avatar photo" height="50" width="50"></span>
								<textarea name="content" id="comment" tabindex="4"
							...
							<div class="comment-show" style="display:none;">
								<ul>
									<li class="form-inline"><label><span style="color: red;">*&nbsp;</span>名称（必填）：</label> <input
										type="text" name="userName" id="author" value="" tabindex="1">
									</li>
									<li class="form-inline"><label><span style="color: red;">*&nbsp;</span>邮箱（必填）：</label> <input
										type="text" name="email" id="email" value="" tabindex="2">
									</li>
								</ul>
							</div>
						</form>
					...
					<p id="prompt">已经有 <s:property value='#request.comments.size()'/>人抢在你前面了~</p>
					<ul class="commentlist">
						<s:iterator value="#request.comments" var="comm">
						<li class="comment" id="li-comment-">
							<div class="comment_body">
								...
								<div class="comment_data">
									<span class="name">${comm.userName }</span>
									<span class="time">${comm.commentTime }</span>
	...
	<footer>
		...
		<div class="Copyright">
			<p>© 2014 爱在发烧Powered by WordPress Theme forget</p>
		</div>
	</footer>
