...
<body>
	...
	<div class="mainContent">
		...
		<div class=" jsc-sidebar-content jsc-sidebar-pulled">
			...
			<div class="content">
			<article style="margin-left: 0px;" id="post-828">
				<h2 class="title" style="text-align: center;">
					<a class="slow" title="${album.albumName }">${album.albumName }</a>
				</h2>
				...
				<div>
					...
					<div class="tjqpost">
						<p><img alt="" src="upload/${photo.photoName}" height="240" width="320"></p>
						<div class="picname">${photo.photoName}</div>
					</div>
					</s:iterator>
					</s:if>
					<s:else>
						<h2 style="text-align: center;">该相册还未上传照片哦！</h2>
					</s:else>
				</div>
				<div class="clean"></div>
				</article>
