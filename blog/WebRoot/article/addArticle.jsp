...
<section class="content">
	<section class="widget" style="min-height:550px">
		...
		<form action="Article_add" id="form_rec" method="post">
		<div class="content">
			<div class="field-wrap">
				文章标题：<input class="s-title" type="text" name="title"/>
			</div>
			<div class="field-wrap">
				文章分类：
			...
			<div class="field-wrap wysiwyg-wrap">
				<textarea class="post s-content" rows="22" name="content"></textarea>
			</div>
