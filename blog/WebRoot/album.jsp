...
<body>
	<header class="l-header"
		...
		<div class="m-nav">
			<ul class="nav">
				...
				<li class="menu-item current-menu-item"><a href="album.jsp">照片墙</a></li>
	...
	<div class="mainContent">
		...
		<div class=" jsc-sidebar-content jsc-sidebar-pulled">
			...
			<div class="content">
			<article class="post-828 page type-page status-publish hentry"
				style="margin-left: 0px;" id="post-828">
				<h2 class="title" style="text-align: center;">
					<a class="slow" title="我的相册">我的相册</a>
				</h2>
				<s:action name="Album_findAll" executeResult="false" ignoreContextParams="false"></s:action>
				<ul class="text">
					<div class="readers">
						<s:iterator value="#request.albums" var="album">
						<a class="item-top" href="Photo_findByAlbum?albumId=${album.albumId }">
							<p><img alt="" src="images/album.jpg" class="avatar avatar-32 photo" height="170" width="170"></p>
