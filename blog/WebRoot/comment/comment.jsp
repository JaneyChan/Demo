...
<nav>
	<ul>
		...
		<li>
			<a href="<%=path %>/album/category.jsp"><span class="icon">&#127748;</span>相册管理</a>
			<ul class="submenu">
...
<section class="content">
	<section class="widget">
		...
		<s:action name="Comment_findAll" executeResult="false" ignoreContextParams="false"></s:action>
		<div class="content">
				...
				<thead>
					...
					<s:iterator value="#request.comments" var="comm">
						<tr>
							...
							<td>
							<a href="Comment_delete?commentId=${comm.commentId}">删除</a>
						</tr>
					</s:iterator>
					</tbody>
				</table>
