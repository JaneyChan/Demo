	...
	<header class="l-header"
		...
		<div class="m-nav">
			<ul class="nav">
				...
				<li class="menu-item current-menu-item"><a href="Admin_show">关于我</a></li>
			</ul>
		</div>
	</header>
		...
		<div class="jsc-sidebar" id="jsi-nav">
			<aside class="sidebar">
				...
				<div class="m-sidebar">
					...
					<div class="userinfo">
						<p class="q-fans">我的基本信息</p>
						<p>昵称：${info.nickName }</p>
						<p>籍贯：${info.nativePlace }</p>
						<p>通讯地址：${info.address }</p>
					</div>
				</div>
			</aside>
		</div>
