	...
	<section class="widget">
		...
		<div class="content">
			<div style="margin:0 0 10px 0">
				<a href="#myModal" role="button" class="btn" data-toggle="modal">创建相册</a>
			</div>
			<table id="myTable" border="0" width="100">
				<thead>
					...
					<s:if test="#request.albums.size() > 0">
					<tbody>
					<s:iterator value="#request.albums" var="album">
						<tr>
							...
							<td>
							<a href="Album_delete?albumId=${album.albumId}">删除</a>/
							<a href="Album_findById?albumId=${album.albumId}">修改</a></td>
						</tr>
					</s:iterator>
					</s:if>
					<s:else>
						<tr>
							<td colspan="4">您还创建相册哦</td>
						</tr>
					</s:else>
					</tbody>
					</tbody>
...
<div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">  
    <div class="modal-header">  
        ...
        <h2 id="myModalLabel">创建相册</h2>  
    </div>  
    <form action="Album_add" method="post">
    <div class="modal-body">  
         <input type="text" style="height: 40px; width:100%" placeholder="相册名" name="albumName"/>
    	<%-- <s:textfield name="albumName" label="分类名"/> --%>
    </div>  
